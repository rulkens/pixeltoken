...
import PixelTokenContract from '../build/contracts/PixelToken.json'
    ...
    instantiateContract () {
        ...
        this.state.web3.eth.getAccounts((error, accounts) => {
            pixelToken.deployed().then((instance) => {
                ...
                // Store the owner, our first owner by default
                return pixelTokenInstance.setOwner(accounts[0], {from : accounts[0]})
                //return;
            }).then((result) => {
                // Get the value from the contract to prove it worked.
                return pixelTokenInstance.getOwner.call(accounts[0])
            }).then((result) => {
